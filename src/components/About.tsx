...
const skills = [
  { name: "JavaScript", icon: DiJavascript1, level: 30 },
  { name: "HTML", icon: DiHtml5, level: 45 },
  ...
  { name: "React", icon: DiReact, level: 45 },
  { name: "CSS", icon: DiCss3, level: 35 },
  { name: "Tailwind CSS", icon: SiTailwindcss, level: 40 },
  { name: "Node.js", icon: DiNodejsSmall, level: 30 },
  { name: "Git", icon: DiGit, level: 25 },
  { name: "GitHub", icon: DiGithubBadge, level: 35},
