...
const projectsData = [
	...
	},
	{
		...
		description:
			"Um blog completo dedicado à conscientização da Fibromialgia, com painel administrativo, banco de dados e editor de texto rico! (A pedido de minha mãe, Priscila Veiga)",
		image: "/project2.jpg",
	...
	},
	{
		...
		description:
			"Uma aplicação imersiva para um Museu virtual, (Fictício), focada na Arte de contar histórias geracionais através de Experiências Imersivas Sensoriais.",
		image: "/project3.jpg",
		tags: ["React", "Tailwind CSS", "Radix UI", "TypeScript"],
		github: "https://github.com/DPViega/projeto-museu-do-legado",
		demo: "https://museu-do-legado.vercel.app/",
	},
];
			...
			<div className="max-w-6xl mx-auto">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
					{projectsData.map((project, index) => (
						<div
							key={project.id}
							className={`group relative bg-glass rounded-xl overflow-hidden border border-primary/20 hover:border-primary/50 transition-all duration-500 ${visibleProjects.includes(index)
						...
						>
							...
							<div className="relative h-48 bg-gradient-to-br from-primary/20 to-cyan-400/20 overflow-hidden">
								...
								{/* Overlay de hover */}
								<div
									className={`absolute inset-0 bg-primary/20 backdrop-blur-sm flex items-center justify-center gap-4 transition-opacity duration-300 ${hoveredProject === project.id
										? "opacity-100"
										: "opacity-0"
										}`}
								>
