...
const projectsData = [
	{
		...
		image: "/project1.jpg",
		tags: ["React", "Node.js", "Lovable", "HTML", "CSS", "Claude.ai", "Node.js", "Python"],
	...
	},
	{
		...
		description:
			"Um protótipo, (até então), de um site para a conscientização da Fibromialgia. (A pedido de minha mãe, Priscila Veiga)",
		image: "/project2.jpg",
	...
	},
	{
		...
		description:
			"Aplicação para gerenciamento de tarefas com interface minimalista e intuitiva",
		image: "/project3.jpg",
